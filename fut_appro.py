...
Modo: {globals().get("modo_operativo", "Normal")}

Tipo: {"AGRESIVA" if globals().get("modo_operativo", "Normal") in ["Agresivo", "Scalping agresivo"] else "NORMAL"}
FVG: {fvg_label}
...
try:
    ...
    valid_msg = build_valid_signal_msg(
