...
st.title("BTCUSDT FUTURES DASHBOARD")
...
try:
    ...
    df_4h, df_1h, df_15m, df_5m = load_all_data()
    ...
    c1.metric("4H", trend_icon(t4))



    c2.metric("1H", trend_icon(t1))



    c3.metric("15M", trend_icon(t15))



    c4.metric("5M", trend_icon(t5))



    c5.metric("Estructura 5M", structure)
    ...
    g2.metric("Riesgo fijo", f"{risk_usd:.2f} USDT")



    g3.metric("Tamaño sugerido", f"{btc_size:.5f} BTC")



    g4.metric("Nocional", f"{notional:.2f} USDT")



    g5.metric("Margen aprox.", f"{margin_needed:.2f} USDT")
