...
try:
    ...
    fig.add_hline(y=sl, line_color="red", line_with=3, annotation_text="SL", annotation_position="right")
    fig.add_hline(y=tp, line_color="green", line_with=3, annotation_text="TP", annotation_position="right")
    fig.add_hline(y=price, line_color="black", line_with=3, annotation_text="Entrada", annotation_position="right")
