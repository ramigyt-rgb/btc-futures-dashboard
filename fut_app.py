...
def get_msgs_safe(a, row, config):
    ...
    if isinstance(msgs, dict):
        ...
        return {
            ...
            "valid": msgs.get("valid", "Mensaje valid no disponible"),

            "almost": msgs.get("almost", "Mensaje almost no disponible"),

            "bias": msgs.get("bias", "Mensaje bias no disponible"),

            "risk": msgs.get("risk", "Mensaje risk no disponible"),
    ...
    return {
        ...
        "valid": "Mensaje valid no disponible",

        "almost": "Mensaje almost no disponible",

        "bias": "Mensaje bias no disponible",

        "risk": "Mensaje risk no disponible",
