...
def render_trading_assistant_card(
    ...
    tendencia_txt = "ALCISTA" if candidate_direction == "LONG" else "BAJISTA" if candidate_direction == "SHORT" else "NEUTRAL"
    if decision == "LONG":
    ...
    ">
        ...
        <div style="font-size:17px; line-height:1.9;">
            ...
            Delta: <b>{delta_estado}</b> · fuerza <b>{delta_fuerza:.2f}</b><br>
