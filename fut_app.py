...
def choose_candidate_direction(long_score, short_score, t1d, t4, t1, t15, t5, structure, price, df_15m):
...
def validate_trade(
    ...
    if direction == "LONG":
        ...
        if market_bias == "SHORT":
            ...
            motivos.append("La intención principal contradice LONG.")
    ...
    if direction == "SHORT":
        ...
        if market_bias == "LONG":
            ...
            motivos.append("La intención principal contradice SHORT.")
...
try:
    ...
    candidate_direction = choose_candidate_direction(
    ...
    quality_score, quality_label = setup_quality(
    ...
    if decision == "LONG":
        ...
        st.markdown(
            ...
            <div class="decision-card decision-long">

                🟢 LONG PERMITIDO

                <div style="font-size:16px;font-weight:500;margin-top:8px;">

                    Calidad: {quality_label} · {quality_score}/10
        ...
        st.markdown(
            ...
            <div class="decision-card decision-short">
        ...
        st.markdown(
            ...
            <div class="decision-card decision-no">
                ...
                <div style="font-size:16px;font-weight:500;margin-top:8px;">
                    ...
                    Escenario calculado: {candidate_direction} · Calidad: {quality_label} · {quality_score}/10
    ...
    q1.markdown(
        ...
        <div class="info-card">
            ...
            <div class="info-title">CALIDAD DEL SETUP</div>

            <div class="info-value">{quality_label}</div>

            <div>{quality_score}/10</div>
    ...
    q2.markdown(
        ...
        <div class="info-card">
            ...
            <div class="info-title">DISTANCIA AL SL</div>

            <div class="info-value">{risk_points_calc:,.0f} pts</div>

            <div>ATR 15M: {atr_15m:,.0f} pts</div>
    ...
    q3.markdown(
        ...
        <div class="info-card">
            ...
            <div class="info-title">SETUP CALCULADO</div>

            <div class="info-value">{candidate_direction}</div>

            <div>RR: {rr_real:.2f}</div>
    ...
    r2.metric("SL técnico", f"{sl:,.0f}" if not pd.isna(sl) else "—")

    r3.metric("TP automático", f"{tp:,.0f}" if not pd.isna(tp) else "—")

    r4.metric("Distancia SL", f"{risk_points_calc:,.0f} pts" if not pd.isna(risk_points_calc) else "—")

    r5.metric("RR real", f"{rr_display:.2f}" if not pd.isna(rr_display) else "—")
    ...
    with st.expander("📘 Reglas del sistema"):
        ...
        - El sistema puede calcular un escenario aunque la decisión sea NO OPERAR.
        ...
        - No operar si Long y Short Score están empatados sin estructura clara.

        - No operar contra una intención principal fuerte.
