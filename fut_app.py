...
try:
    ...
    with tab2:
        ...
        # acá va TODO el bloque del gráfico:
        # chart_df = ...
        # fig = go.Figure()
        # fig.add_trace(...)
        # st.plotly_chart(...)
