...
def choose_candidate_direction(long_score, short_score, t1d, t4, structure, price, df_15m):
...
try:
    ...
    # CARTEL PRINCIPAL SIN HTML ROTO
    ...
    q3.metric(
        ...
        f"RR: {rr_real:.2f}" if not pd.isna(rr_real) else "—"
