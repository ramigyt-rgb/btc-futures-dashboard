...
modo_operativo = st.sidebar.selectbox("Modo de operación", ["Conservador", "Normal", "Agresivo", "Scalping agresivo"], index=1, key="modo_operativo_select")
...
try:
    ...
    if show_fvg_zones and not fvg_df.empty:
        open_fvg = fvg_df.tail(12) if show_mitigated_fvg else fvg_df[~fvg_df["mitigated"].astype(bool)].tail(8)
