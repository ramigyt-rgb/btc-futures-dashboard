...
try:
    ...
    fig.add_hline(y=sl, line_dash="dash", annotation_text="SL", annotation_position="right")
    fig.add_hline(y=tp, line_dash="dash", annotation_text="TP", annotation_position="right")
    fig.add_hline(y=price, line_dash="dot", annotation_text="Entrada", annotation_position="right")
