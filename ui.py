    ...
    try:
        ...
        with tab2:
            ...
            if not pd.isna(sl_calc):
                fig_btc.add_hline(y=sl_calc, line_color="red", line_width=2, annotation_text="SL")
            if not pd.isna(tp_calc):
                fig_btc.add_hline(y=tp_calc, line_color="green", line_width=2, annotation_text="TP")
            fig_btc.add_hline(y=price, line_color="black", line_width=2, annotation_text="Entrada")
        ...
        with tab4:
            ...
            st.subheader("📌 Métricas operativas")
                # acá van q1 q2 q3, col1, c1, g1, r1, etc.
        with tab5:
