...
def render_dashboard():
    try:
        ...
        with tab2:
            ...
            show_emas = modo_grafico in ["Simple", "Pro", "Institucional"]
            show_sl_tp = modo_grafico in ["Simple", "Pro", "Institucional"]
            show_liquidez = modo_grafico in ["Pro", "Institucional"]
            show_fvg = modo_grafico in ["Pro", "Institucional"]
            show_order_blocks = modo_grafico == "Institucional"
            show_eq_levels = modo_grafico == "Institucional"
            show_volumen = modo_grafico == "Institucional"
        ...
        if show_liquidez and volume_profile:
            fig.add_hline(
