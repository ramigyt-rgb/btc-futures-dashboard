...
def render_dashboard():
    try:
        ...
        with tab1:
            ...
            <div class="mini-card"><span>Precio BTCUSDT</span><b>{price:,.2f}</b></div>

            <div class="mini-card"><span>Long Score</span><b>{long_score}/10</b></div>

            <div class="mini-card"><span>Short Score</span><b>{short_score}/10</b></div>

            <div class="mini-card"><span>RSI 15M</span><b>{rsi_15:.2f}</b><small>{rsi_label}</small></div>
            ...
            <div class="mini-card"><span>Calidad</span><b>{quality_label}</b><small>{quality_score}/10</small></div>

            <div class="mini-card"><span>Distancia SL</span><b>{risk_points_calc:.0f} pts</b><small>ATR 15M</small></div>

            <div class="mini-card"><span>Setup</span><b>{display_direction(candidate_direction)}</b><small>RR {rr_real:.2f}</small></div>

            <div class="mini-card"><span>Distancia TP</span><b>{tp_distance_calc:.0f} pts</b><small>{tp_distance_calc / atr_15m:.2f} ATR</small></div>

            <div class="mini-card"><span>FVG</span><b>{fvg_label}</b><small>{fvg_distance_atr:.2f} ATR</small></div>
